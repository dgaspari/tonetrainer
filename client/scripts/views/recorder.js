...
var RecorderView = Backbone.View.extend({
  ...
  charList: [
    ...
    { character: '年轻', filename: 'nianqing01', pinyin: 'niánqīng' },
    { character: '年轻', filename: 'nianqing02', pinyin: 'niánqīng' },
    ...
    { character: '性感', filename: 'xinggan01', pinyin: 'xìnggǎn' },
    { character: '性感', filename: 'xinggan02', pinyin: 'xìnggǎn' },
